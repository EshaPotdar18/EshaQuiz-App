    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href=" " style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Esha Potdar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9876543210</h4>
		<h4 style="font-family:'typo' ">esha.potdar@gmail.com</h4>
		<h4 style="font-family:'typo' ">Vellore Insitute of Technology ,Chennai</h4></div></div>
		</p>
      </div>
